...
const ForgetPasswordPage = (props) => {
  ...
  document.title =
    "Восстановление пароля | Upzet - Шаблон администраторской панели React";

  const validation = useFormik({
    // enableReinitialize : использовать этот флаг, когда начальные значения нужно изменить
                  ...
                  <Row>
                    <Col xs={7}>
                      <div className="text-primary p-4">
                        ...
                        <p>
                          Введите данные, чтобы продолжить работу в Бебинокль.
                        </p>
                      </div>
                    </Col>
